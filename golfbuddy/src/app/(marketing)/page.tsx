    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <section className="text-center py-16">
        ...
        <p className="text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto mb-8">
          Get personalized video analysis and actionable drills from an experienced coach. 
          Improve your game without expensive in-person lessons.
        </p>
      ...
      <section className="py-16 border-t border-zinc-200 dark:border-zinc-800">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-zinc-600 dark:text-zinc-400">Select swing, short game, or putting and describe what you want to improve.</p>
          </div>
          <div className="text-center">
            <div className="w-12 h-12 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-zinc-600 dark:text-zinc-400">Record and upload specific shots following our simple filming guide.</p>
          </div>
          <div className="text-center">
            <div className="w-12 h-12 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-zinc-600 dark:text-zinc-400">Receive a detailed video response with personalized drills within 48 hours.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 border-t border-zinc-200 dark:border-zinc-800">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-zinc-600 dark:text-zinc-400">
            Former All-Conference Division I golfer at UC San Diego and Cal Poly with years of coaching 
            and competitive playing experience. Learned from some of the world&apos;s top swing, short game, 
            and putting coaches while competing at the highest levels.
          </p>
        </div>
      </section>
    </div>
